...
//#define THIRD_SEGMENT_ENABLE    4
//#define FOURTH_SEGMENT_ENABLE   4


#define FIRST_SEGMENT_ENABLE    5
#define SECOND_SEGMENT_ENABLE   4
#define THIRD_SEGMENT_ENABLE    3
#define FOURTH_SEGMENT_ENABLE   2
